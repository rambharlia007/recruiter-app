...
class Process extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      assignedId: "",
      personId: parsed.id,
      recruiterId: parsed.rid
    };
  }

  setFitmentEvaluationRoundData() {
    var data = { ...fitmentEvaluationRoundData };
    var interviewee = this.state.interviewers.filter(e => {
      return e._id == this.state.recruiterId;
    })[0];
    data.assignedTo = interviewee.username;
    data.isEditable = this.state.currentUserId == this.state.recruiterId;
  ...
  componentDidMount() {
    ...
    axios
      ...
      .then(function(response) {
        ...
        self.setFitmentEvaluationRoundData();
      })
              ...
              >
                <small
                  ...
                  onClick={() => {
                    ...
                    this.setState({
                      technicalRound: x,
                      fitmentEvaluationRound: fitmentEvaluationRound
                    });
                  }}
                >
